...
const QuoteModal = ({ isOpen, onClose, product }) => {
  ...
  const isCampanaCuadrada = nameLower.includes('cuadrada');
  const isCampana = nameLower.includes('campana') && !isCampanaCuadrada;
    ...
    <div className="quote-modal-overlay" onClick={handleOverlayClick}>
      <div className="quote-modal-content">
        ...
        <form onSubmit={handleSubmit} className="quote-form">
          ...
          {!isCampanaCuadrada && !isCampana && !isCodo && !isChimenea && (
            <div className="form-group">
